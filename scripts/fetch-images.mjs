/**
 * Build-time image pipeline for LogicForge.
 *
...
const ASSETS = [
  { name: 'hero', query: 'circuit board macro blue technology dark', w: 3840, orientation: 'landscape' },
  { name: 'feature-gates', query: 'microchip processor macro', w: 1600, orientation: 'landscape' },
  { name: 'feature-wires', query: 'electronics wires circuit closeup', w: 1600, orientation: 'landscape' },
  { name: 'feature-sim', query: 'blue data network abstract', w: 1600, orientation: 'landscape' },
  { name: 'showcase', query: 'server motherboard technology dark', w: 2560, orientation: 'landscape' },
];
...
async function main() {
  ...
  for (const asset of ASSETS) {
    ...
    credits.push({
      ...
      authorUrl: `${photo.user.links.html}?utm_source=logicforge&utm_medium=referral`,
      source: `${photo.links.html}?utm_source=logicforge&utm_medium=referral`,
    });
